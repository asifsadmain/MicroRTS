...
import ai.synthesis.Synthesis_Base.CFG_Actions.Attack;
import ai.synthesis.Synthesis_Base.CFG_Actions.Build;
import ai.synthesis.Synthesis_Base.CFG_Actions.Harvest;
import ai.synthesis.Synthesis_Base.CFG_Actions.Idle;
import ai.synthesis.Synthesis_Base.CFG_Actions.MoveAway;
import ai.synthesis.Synthesis_Base.CFG_Actions.Train;
import ai.synthesis.Synthesis_Base.CFG_Actions.moveToUnit;
import ai.synthesis.Synthesis_Base.CFG_Condition.CanAttack;
import ai.synthesis.Synthesis_Base.CFG_Condition.CanHarvest;
import ai.synthesis.Synthesis_Base.CFG_Condition.HasLessNumberOfUnits;
import ai.synthesis.Synthesis_Base.CFG_Condition.HasNumberOfUnits;
import ai.synthesis.Synthesis_Base.CFG_Condition.HasNumberOfWorkersHarvesting;
import ai.synthesis.Synthesis_Base.CFG_Condition.HasUnitInOpponentRange;
import ai.synthesis.Synthesis_Base.CFG_Condition.HasUnitThatKillsInOneAttack;
import ai.synthesis.Synthesis_Base.CFG_Condition.HasUnitWithinDistanceFromOpponent;
import ai.synthesis.Synthesis_Base.CFG_Condition.HaveQtdUnitsAttacking;
import ai.synthesis.Synthesis_Base.CFG_Condition.Is_Builder;
import ai.synthesis.Synthesis_Base.CFG_Condition.OpponentHasNumberOfUnits;
import ai.synthesis.Synthesis_Base.CFG_Condition.OpponentHasUnitInPlayerRange;
import ai.synthesis.Synthesis_Base.CFG_Condition.OpponentHasUnitThatKillsUnitInOneAttack;
import ai.synthesis.Synthesis_Base.CFG_Condition.is_Type;
